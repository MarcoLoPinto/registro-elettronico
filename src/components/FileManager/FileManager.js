        ...
        return(
            <div className="d-flex flex-row box-size align-items-center justify-content-between margin-filemanager">
                ...
                <div className="d-flex flex-column">
                    ...
                    <p className="no-margin-p">{this.props.type}</p>
                </div>
                <div className="d-flex flex-column align-items-stretch buttonlist-stretch">
                    {this.props.viewable?<MainButton className="no-padding-btn margin-btn">Visualizza</MainButton>:""}
                    {this.props.downloadable?<MainButton className="no-padding-btn margin-btn">Scarica</MainButton>:""}
                    {this.props.deletable?<MainButton className="no-padding-btn margin-btn">Elimina</MainButton>:""}
                </div>
